...
import { RulerFilter, RulerConfig, RelationConfig } from '../src/types/definitions'
import {
  validatorLandmarkRole, validatorSidebarItem, validatorSidebarRole, validatorRulerFilter, validatorRulerConfig, validatorRulerRole, 
  validatorRelationConfig, validatorEventNode, validatorLayouts, validatorEffects, validatorThemeConfig, validatorTimelineOptions, 
...
describe('Validator Tests', () => {
  ...
  describe('validatorEventNode', () => {
    ...
    it('should validate relation correctly', () => {
      const validRelation: RelationConfig = {
        before: '123',
        after: '456',
        lineSize: 5,
        lineColor: 'red',

...
import { isObject, isNumberString, isBooleanString, isEmptyObject, isValidURL, isValidPath, isURLOrPath, basename, getExt, inRange, inArray, getDuplicateValues, snakeToCamel, ensureEndsWithS, sprintf, hash, deepMergeObjects, deepCloneObject, cloneObject } from '../src/utils/common'
...
describe('isBooleanString', () => {
    ...
    it('should handle null as falsy', () => {
        expect(isBooleanString(null as unknown as string)).toEqual(false)
    })
    it('should handle undefined as falsy', () => {
        expect(isBooleanString(undefined as unknown as string)).toEqual(false)
    })
    
    it(`should handle 0 as falsy`, () => {
        expect(isBooleanString(0 as unknown as string)).toEqual(false)
    })
    
    it(`should handle 1 as falsy`, () => {
        expect(isBooleanString(1 as unknown as string)).toEqual(false)
    })
    ...
    it('should handle numbers as falsy', () => {
        expect(isBooleanString(33 as any)).toEqual(false)
    })
    ...
    it('should handle boolean as falsy', () => {
        expect(isBooleanString(true as unknown as string)).toEqual(false)
    })

    it('should handle boolean as falsy', () => {
        expect(isBooleanString(false as unknown as string)).toEqual(false)
    })
    ...
    it('returns false for non-string values', () => {
        expect(isBooleanString(true as unknown as string)).toBe(false)
        expect(isBooleanString(false as unknown as string)).toBe(false)
        expect(isBooleanString(123 as unknown as string)).toBe(false)
        expect(isBooleanString(null as unknown as string)).toBe(false)
        expect(isBooleanString(undefined as unknown as string)).toBe(false)
    })
...
describe('isEmptyObject', () => {
    ...
    it('should handle undefined', () => {
        expect(isEmptyObject(undefined as unknown as string)).toEqual(false)
    })
...
describe('isURLOrPath', () => {
    ...
    it('should handle null', () => {
        expect(isURLOrPath(null as unknown as string)).toBe(false)
    })

    it('should handle undefined', () => {
        expect(isURLOrPath(undefined as unknown as string)).toBe(false)
    })
    ...
    it('should handle number', () => {
        expect(isURLOrPath(123 as unknown as string)).toBe(false)
    })
...
describe('inRange', () => {
    ...
    it('should handle undefined', () => {
        expect(inRange(undefined as unknown as number, undefined as unknown as number, undefined as unknown as number)).toEqual(false)
    })
    
    it('should handle empty strings', () => {
        expect(inRange('' as unknown as number, undefined as any, undefined as any)).toEqual(false)
    })

    it('should handle numeric strings', () => {
        expect(inRange('1' as unknown as number, '2' as unknown as number, '3' as unknown as number)).toEqual(false)
    })
...
describe('inArray', () => {
    ...
    it('should handle undefined', () => {
        expect(inArray(undefined as any, undefined as any)).toEqual(false)
    })

    it('should handle empty strings', () => {
        expect(inArray('', undefined as any)).toEqual(false)
    })
    ...
    it('returns false if targetArray is not an array', () => {
        expect(inArray('value', 'not an array' as any)).toBe(false)
    })
    ...
    it('should handle unmatched value from object[]', () => {
        expect(inArray({ name: 'Joe' } as any, [ { name: 'Joe' }, { name: 'Mike' }, { name: 'Sara' } ] as any)).toEqual(false)
    })

    it('should handle matched empty from string[]', () => {
        expect(inArray('', [ 'first', 'second', 'third', '', '', null as any ])).toEqual(true)
    })

    it('should handle matched null from string[]', () => {
        expect(inArray(null as any, [ 'first', 'second', 'third', '', null as any, '' ])).toEqual(true)
    })
    ...
    it('should handle unmatched from date object[]', () => {
        ...
        expect(inArray(needleDate as any, [new Date("2024-04-29T12:34:56.789Z"), new Date("2024-05-04T01:23:45.678Z"), new Date()] as any)).toEqual(false)
    })
...
describe('snakeToCamel', () => {
    ...
    it('should handle number', () => {
        expect(snakeToCamel(123 as any)).toEqual('')
    })
...
describe('hash', () => {
    ...
    it('should handle number', () => {
        expect(hash(123 as any)).toEqual(3338908027751811)
    })

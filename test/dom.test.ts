...
import {
    ...
    replaceAttribute, wrapChildNodes, isHidden, hide, show, toggleClass, reflow, CallbackFunction, watcher
} from '../src/utils/dom'
...
describe.skip('watcher', () => {
    ...
    it('should execute the callback function for each observed mutation', () => {
        ...
        observerMock.callback(mutationsMock, observerMock as unknown as MutationObserver)
    ...
    it('should log an error message if the target element is not valid', () => {
        ...
        watcher(null as unknown as HTMLElement, callbackMock)
    ...
    it('should do nothing if the callback function is not valid', () => {
        ...
        watcher(elementMock, null as unknown as CallbackFunction)

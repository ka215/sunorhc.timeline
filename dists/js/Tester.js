(function(g,p){typeof exports=="object"&&typeof module<"u"?p(exports):typeof define=="function"&&define.amd?define(["exports"],p):(g=typeof globalThis<"u"?globalThis:g||self,p(g.Sunorhc={}))})(this,function(g){"use strict";function p(i){var h;const v={toggleRtl:`  <div class="flex flex-col items-start w-28 h-max">
  ...
  </div>`},x=["selectTimeZone","selectStartWeekday","togglePresentMarker","verticalDivider","toggleRtl","selectOutlined","selectElevation","selectPlacement","selectCanvasLayout","toggleDayColored","grainWidth","rowHeight","verticalDivider","selectAlignment","toggleTooltip","selectEventOpener","runReload","verticalDivider","toggleScaleTracker","scaleSwitcher","optionViewer"];let f=`<div class="inline-flex items-center justify-center w-full">
